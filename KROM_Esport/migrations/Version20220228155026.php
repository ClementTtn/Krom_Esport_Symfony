 ...
 */
final class Version20220228155026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE direction (id INT AUTO_INCREMENT NOT NULL, role VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) NOT NULL, age INT DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, img VARCHAR(255) NOT NULL, lien LONGTEXT DEFAULT NULL, circuit LONGTEXT DEFAULT NULL, voiture LONGTEXT DEFAULT NULL, palmares LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
