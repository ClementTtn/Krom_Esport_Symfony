 ...
 */
final class Version20220330170320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidat (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, age INT NOT NULL, plateforme VARCHAR(255) NOT NULL, simulation VARCHAR(255) NOT NULL, presentation LONGTEXT NOT NULL, materiel VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photos CHANGE src src VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
